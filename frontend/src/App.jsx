    ...
    <div className="wrap">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .header { background: rgba(255,255,255,0.62); backdrop-filter: blur(14px) saturate(150%); -webkit-backdrop-filter: blur(14px) saturate(150%); border-bottom: 1px solid rgba(255,255,255,0.7); color: var(--ink); padding: 22px 24px 20px; position: relative; }
        ...
        .user-chip { display:flex; align-items:center; gap:8px; background: rgba(255,255,255,0.65); border:1px solid rgba(255,255,255,0.9); padding: 5px 6px; border-radius: 999px; transition: background 0.15s ease; }
        ...
        .dropdown-trigger { display:flex; align-items:center; gap: 8px; background: rgba(255,255,255,0.68); border: 1px solid rgba(255,255,255,0.9); color: var(--ink); padding: 8px 12px; border-radius: 9px; font-size: 13px; font-weight: 500; cursor: pointer; transition: border-color 0.15s ease, background 0.15s ease; }
        .dropdown-trigger:hover { border-color: var(--accent-light); background: rgba(255,255,255,0.85); }
        .dropdown-menu { position: absolute; top: calc(100% + 8px); left: 0; min-width: 210px; max-width: calc(100vw - 32px); background: rgba(255,255,255,0.92); backdrop-filter: blur(20px) saturate(160%); -webkit-backdrop-filter: blur(20px) saturate(160%); border: 1px solid rgba(255,255,255,0.9); border-radius: 12px; box-shadow: 0 14px 34px rgba(80,60,160,0.18); padding: 6px; z-index: 40; animation: dropIn 0.14s ease; }
        ...
        .stat-card { position:relative; background: rgba(255,255,255,0.62); border: 1px solid rgba(255,255,255,0.85); border-radius: 13px; padding: 13px 16px; transition: background 0.15s ease, transform 0.12s ease; }
        ...
        .toolbar-card { background: rgba(255,255,255,0.85); border: 1px solid rgba(255,255,255,0.9); border-radius: 14px; padding: 12px; display:flex; flex-wrap:wrap; gap:8px; align-items:center; box-shadow: 0 10px 28px rgba(80,60,160,0.08); }
        ...
        .btn-ghost { background: rgba(255,255,255,0.85); color: var(--ink); border:1px solid var(--line); }
